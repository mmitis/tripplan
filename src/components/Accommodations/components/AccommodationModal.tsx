...
import { TripAccommodationProvider } from "@prisma/client";

interface AccommodationModalProps {
  open: boolean;
  onClose: () => void;
  onAccept: (confirmationLink: string) => void;
}

export const AccommodationModal = ({
  open,
  onClose,
  onAccept,
              ...
              <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-sm sm:w-full sm:p-6">
                  ...
                  <div className="mt-3 text-center sm:mt-5">
                    ...
                    <div className="mt-2">
                      <p className="text-sm text-gray-500 mb-3">
                        Paste confirmation link of the booking
                      </p>
                      <div className="w-full">
                        ...
                        >
                          <option value={TripAccommodationProvider.BOOKING}>
                            Booking.com
                          </option>
                        </select>
                      </div>
                      <div className="w-full mt-2">
                        ...
                        <input
                          ...
                          onChange={(e) =>
                            setConfirmationLink(e.currentTarget.value)
                          }
                ...
                <div className="mt-5 sm:mt-6">
                  <button
                    ...
                    onClick={() => onAccept(confirmationLink)}
                  >
                    Import booking info
                  </button>
                </div>
